        ...
        <div className='mt-10'>
            <form onSubmit={ handleFormSubmit }>
                <div className='flex flex-col mb-6'>
                    <label htmlFor='identifier' className='mb-1 text-xs sm:text-sm tracking-wide text-gray-600 font-semibold'>Recipient Email/Mobile Number</label>
                ...
                <div className='flex w-full'>
                    <button type='submit' className='flex items-center justify-center focus:outline-none text-white bg-blue-600 hover:bg-blue-700 rounded py-3 w-full transition duration-150 ease-in'>
                        <span className='mr-2 uppercase font-medium'>Proceed &rarr;</span>
                    </button>
                </div>
            </form>
        </div>
