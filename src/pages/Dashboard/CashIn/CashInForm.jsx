            ...
            <form onSubmit={ handleFormSubmit }>
                <div className='flex flex-col mb-6'>
                    ...
                    <div className='relative'>
                        ...
                        <input id='identifier' type='text' name='identifier' value={ identifier } className='text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400' placeholder='Email or Mobile Number' onChange={ (e) => setIdentifier(e.target.value) } required />
                    </div>
                </div>
                <div className='flex flex-col mb-6'>
                    <label htmlFor='amount' className='mb-1 text-xs sm:text-sm tracking-wide text-gray-600'>Amount</label>
                    <div className='relative'>
                        <div className='inline-flex items-center justify-center absolute left-0 top-0 h-full w-10 text-gray-400'>
                            <svg className='h-6 w-6' fill='none' strokeLinecap='round' strokeLinejoin='round' strokeWidth='2' viewBox='0 0 24 24' stroke='currentColor'>
                        ...
                        <input id='amount' type='number' name='amount' value={ amount } className='text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400' placeholder='0' onChange={ (e) => {
